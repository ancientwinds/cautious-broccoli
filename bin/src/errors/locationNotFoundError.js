...
var LocationNotFoundError = /** @class */ (function (_super) {
    ...
    function LocationNotFoundError(location) {
        var _this = _super.call(this, 'ExceptionNotFoundError') || this;
        _this.message = "Unable to find the provided location: " + location;
        return _this;
    }
